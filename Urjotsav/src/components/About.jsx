...
function About() {
  ...
  return (
    ...
    <div id='Urjotsav_title' className='h-auto w-[65vw] ' style={{ textAlign: 'center', color: 'white', fontSize: 130, fontFamily: 'megrim', fontWeight: '500', letterSpacing: 6, wordWrap: 'break-word' }}>ABOUT</div>
