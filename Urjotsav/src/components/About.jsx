...
function About() {
  ...
  return (
    ...
    <button id='expand'  className='border-gray-50 font-Megrim font-bold rounded-full  text-white text-2xl z-30 mt-7 p-3 mb-5 transition-all hover:bg-white hover:text-black' style={{ borderWidth: `2px` }}>Explore more</button>
  </div>  )
}
