    ...
    <>
      <div style={{ backgroundImage: `url(${Layer1})`, backgroundPosition: "center", backgroundSize: "cover" }} className='w-full h-[200vh] overflow-hidden z-4'>
        ...
        <div className=' flex items-center justify-center flex-col mt-10 '>
          ...
          <button className='border-gray-50  rounded-full  text-white text-2xl z-30 mt-7 p-3 mb-5 transition-all hover:bg-white hover:text-black' style={{ borderWidth: `2px` }}>Explore more</button>
        </div>
